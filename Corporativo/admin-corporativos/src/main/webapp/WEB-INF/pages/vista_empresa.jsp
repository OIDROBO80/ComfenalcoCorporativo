...
<div data-ng-controller="vistaEmpresaController as adminCtrl">
    ...
    <div class="col-md-12">
        <div class="panel panel-default" id="divCrearEmp">
            <div class="panel-heading">
                ...
                <br/><br/>
                <a class="btn btn-primary pull-right" data-toggle="modal" data-target="#modalCodList" ng-click="adminCtrl.getlistCodeByPlan()" style="margin-left: 0.5em;">Listado de códigos</a>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <a href="https://logincorp.smartfitcolombia.com/assets/plantillas_widfly/empleados_estructura_cargue.csv" class="form-control btn btn-link" download="download"><div>Importante: El archivo debe cargarse en formato (.csv)</div><div>Descargar formato</div></a>
    ...
    <div class="modal fade" id="modalCodImport" role="dialog">
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <a href="https://logincorp.smartfitcolombia.com/assets/plantillas_widfly/codigos_estructura_cargue.csv" class="form-control btn btn-link" download="download"><div>Importante: El archivo debe cargarse en formato (.csv)</div><div>Descargar formato</div></a>
    ...
    <!-- START Modal CodigoDescuento List -->
    <div class="modal fade" id="modalCodList" role="dialog">
        <div class="modal-dialog">

            <!-- Modal content-->
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">Listado de códigos por plan</h4>
                </div>
                <div class="modal-body">
                    <div data-ng-if="adminCtrl.listCodeByPlan.length > 0" class="form-group col-xs-12 table-code-modal">
                        <table data-ng-if="adminCtrl.listCodeByPlan.length > 0" class="table table-bordered">
                            <thead>
                            <tr>
                                <th>Nombre Plan</th>
                                <th>Cantidad</th>
                            ...
                            <tbody>
                            <tr data-ng-repeat="listCodeByPlan in adminCtrl.listCodeByPlan">
                                <td>{{listCodeByPlan.nombrePlan}}</td>
                                <td>{{listCodeByPlan.cantidadDeCodigos}}</td>
                            </tr>
                            </tbody>
                        </table>
                    </div>
    ...
    <!-- END Modal CodigoDescuento List -->
