 ...
 * @version 1.0
 */
public class CrearConvenioEmpresaRs {
	...
	// probablemtente no se usaran estos
	 ...
	 * @param {List<EmpresaAfiliadoModel>} el nuevo valor para la propiedad afiliadosAsignados
	 */
	 ...
	 * @param {List<String>} el nuevo valor para la propiedad codigosAsignados
	 */
	 ...
	 * @param {List<EmpresaAfiliadoModel>} el nuevo valor para la propiedad afiliadosError
	 */
	 ...
	 * @param {List<String>} el nuevo valor para la propiedad mensajesError
	 */
	 ...
	 * @param {String} el nuevo valor para la propiedad csvAfiliadosFallidos
	 */
	 ...
	 * @param {String} el nuevo valor para la propiedad csvAfiliadosCompletos
	 */
