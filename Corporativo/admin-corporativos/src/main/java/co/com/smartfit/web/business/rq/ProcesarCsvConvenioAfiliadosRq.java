 ...
 * @version 1.0
 */
public class ProcesarCsvConvenioAfiliadosRq {
	// datos genericos
	...
	/**
	 * Metodo que obtiene el valor asociado a la propiedad csvAfiliados
	 * @return {String} el valor asociado a la propiedad csvAfiliados
	 */
	public String getCsvAfiliados() {
		return csvAfiliados;
	}
	/**
	 * Metodo que permite modificar el valor de la propiedad csvAfiliados
	 * @param {String} el nuevo valor para la propiedad csvAfiliados
	 */
	public void setCsvAfiliados(String csvAfiliados) {
		this.csvAfiliados = csvAfiliados;
	}
	/**
